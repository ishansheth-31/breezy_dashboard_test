...
# Initialize session state for selected_patient_id if it doesn't exist
...
# Update selected patient ID in session state when patient is selected from dropdown
